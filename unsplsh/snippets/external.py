...
from unsplsh.settings import UNSPLASH_KEY, UNSPLASH_URL


def unsplash_builder(search) -> str:
    search_url = UNSPLASH_URL + f"?query={search.query}"
    ...
    search_url += f"&client_id={UNSPLASH_KEY}"
    return search_url
